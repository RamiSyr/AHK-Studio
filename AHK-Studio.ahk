...
FileCheck(file:=""){
	...
	,scidate:=20160512235500,XMLFiles:={menus:[20160719100618,"lib/menus.xml","lib\Menus.xml"],commands:[20160508000000,"lib/commands.xml","lib\Commands.xml"]}
	...
	,DefaultOptions:="Smart_Delete,Manual_Continuation_Line,Full_Auto,Focus_Studio_On_Debug_Breakpoint,Word_Wrap_Indicators,Context_Sensitive_Help,Auto_Complete,Auto_Complete_In_Quotes"
	/*
	...
	if(fn.code=2001){
		...
		*/
		...
		if(sc.2007(start-1)=46){
			...
			if((sc.2202&&v.options.Disable_Auto_Complete_While_Tips_Are_Visible=1)||(sc.2010(cpos)~="\b(13|1|11|3)\b"=1&&v.Options.Auto_Complete_In_Quotes)){
			}else{
