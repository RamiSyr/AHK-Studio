...
Context(return=""){
	...
	while(start<end){
		...
		;m(sc.TextRange(start,end),"first")
		while(start<end){
			found:=[]
			;m(comma,sc.TextRange(start,end))
...
FileCheck(file:=""){
	...
	,scidate:=20160512235500,XMLFiles:={menus:[20160719093558,"lib/menus.xml","lib\Menus.xml"],commands:[20160508000000,"lib/commands.xml","lib\Commands.xml"]}
	...
	,DefaultOptions:="Smart_Delete,Manual_Continuation_Line,Full_Auto,Focus_Studio_On_Debug_Breakpoint,Word_Wrap_Indicators,Context_Sensitive_Help"
	/*
