...
VarBrowser(){
	...
	if(!WinExist(newwin.id))
		debugwin:=newwin:=new GUIKeep(98),newwin.add("TreeView,w200 h200 gvalue vtreeview AltSubmit hwndtreeview,,wh","ListView,w200 r4 AltSubmit gVBGoto,Stack|File|Line,wy","Button,gStopDebug,Stop Debugging,y"),newwin.show("Variable Browser"),hwnd:=newwin.XML.SSN("//*/@hwnd").text,debug.VarBrowser:=1
