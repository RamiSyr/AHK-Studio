...
Color(con:=""){
	...
	}con.4004("fold",[1]),con.2680(3,6),con.2080(8,1),con.2082(8,0xff00ff),con.2242(4,1),con.2240(4,5),con.2110(1)
	con.2080(6,14)
	/*
...
Duplicates(){
	...
	len:=StrPut(search,"UTF-8")-1
	while(found:=sc.2197(len,[search]))>=0{
		sc.2504(found,len),sc.2686(found+1,sc.2006)
	}
	/*
