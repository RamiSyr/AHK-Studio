...
FileCheck(file:=""){
	...
	,scidate:=20160512235500,XMLFiles:={menus:[20160719084632,"lib/menus.xml","lib\Menus.xml"],commands:[20160508000000,"lib/commands.xml","lib\Commands.xml"]}
	...
	,DefaultOptions:={Smart_Delete:1,Manual_Continuation_Line:1,Full_Auto:1}
	/*
