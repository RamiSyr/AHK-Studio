...
Color(con:=""){
	...
	*/
	con.2082(6,0xC08080),sc.2051(151,settings.Get("//debug/continuecolor",0xFF8080))
...
InsertDebugMessage(){
	...
	if(!debug.VarBrowser){
		if(hotkey:=menus.SSN("//*[@clean='List_Variables']/@hotkey").text)
			...
			msg:=" : Click Here to Show the Variable List`n",end:=sc.2006(),sc.2003(end,msg),sc.2032(end+3,151),sc.2033(StrPut(msg,"UTF-8")-1,151),sc.2409(151,1)
	}
	sc.2025(sc.2006)
}
